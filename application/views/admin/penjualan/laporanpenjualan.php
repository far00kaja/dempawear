							...
							<table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
								...
								<tbody>
									...
									<tr>
										...
										<td>
										<?php echo $this->user_model->getById($t->handled)->name ?>
										</td>
										<td>
											<?php echo $t->status ?>	
									    </td>
										...
										<td>
										<?php	if (!empty($t->confirm_by)){ ?>
										<?php echo $this->user_model->getById($t->confirm_by)->name ?>
										<?php }else{ echo '-';} ?>
									    </td>
										<td>
										...
										<td>
											<?php echo $t->bukti_transfer ?>	
									    </td>
										<td>
											<?php echo $t->jenis_pembelian ?>	
									    </td>
										<td>
											<?php echo $t->retur ?>	
									    </td>
